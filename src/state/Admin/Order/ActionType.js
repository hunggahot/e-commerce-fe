...
export const COFIRMED_ORDER_REQUEST = 'COFIRMED_ORDER_REQUEST';
export const COFIRMED_ORDER_SUCCESS = 'COFIRMED_ORDER_SUCCESS';
export const COFIRMED_ORDER_FAILURE = 'COFIRMED_ORDER_FAILURE';
